      ...
      <FormSection dense title="Pickup Address" description="Choose a saved address or add a new one.">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <button
            ...
            className={`flex h-full flex-col items-center justify-center rounded-lg border-2 border-dashed p-4 text-center transition hover:border-blue-400 hover:bg-blue-50/40 ${isAddingNew ? 'border-blue-600 bg-blue-50/40' : 'border-gray-300 bg-white'
              }`}
          >
