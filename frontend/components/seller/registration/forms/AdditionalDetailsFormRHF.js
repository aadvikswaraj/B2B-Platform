...
export default function AdditionalDetailsFormRHF({
  defaultValues = {},
  loading,
  onBack,
  onSubmit,
  ...
  return (
    <form onSubmit={handleSubmit(submit)} className="space-y-6">
      <FormSection
        ...
        description="Tell buyers more about your business."
      >
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <FormField
            ...
            hint="Approximate yearly revenue"
            error={errors.annualTurnover?.message}
          >
            <Select
              id="annualTurnover"
              {...register("annualTurnover", { required: "Select one" })}
            >
          ...
          >
            <Select
              id="employeeCount"
              {...register("employeeCount", { required: "Select one" })}
            >
              <option value="">Select…</option>
