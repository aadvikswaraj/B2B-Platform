            ...
            {tabs.map((t, i) => (
              <button
                ...
                className={clsx(
                  ...
                  i === activeTab ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:text-gray-500',
          ...
          {tabs.map((t, i) => (
            <button
              ...
              className={clsx('relative px-4 py-2 text-sm font-medium rounded-t-md transition',
                i === activeTab ? 'bg-white dark:bg-gray-800 text-indigo-600 shadow-sm' : 'text-gray-600 hover:text-gray-900')}
            >
              {t.icon && <t.icon className="h-4 w-4 inline mr-1" />} {t.label}
            </button>
          ))}
