...
export const SellerProductsAPI = {
  list: async (params = {}) => api(`${base}/list?` + generateQuery(params)),
  create: async (payload) =>
    api(base + "/new", { method: "POST", body: payload }),
  updateTrade: async (id, payload) =>
    api(`${base}/${id}/trade`, { method: "POST", body: payload }),
  updateCore: async (id, payload) =>
    api(`${base}/${id}/core`, { method: "POST", body: payload }),
