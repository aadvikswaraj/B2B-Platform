...
export const update = async (req, res) => {
    try {
        ...
        if (businessType !== undefined) businessUpdates.businessType = businessType;
        ...
        const businessProfile = await profileService.upsertBusinessProfile(userId, businessUpdates);
